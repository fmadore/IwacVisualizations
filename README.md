...
| Sentiment Atlas | page block | **Live** — corpus-level multi-model AI sentiment: polarity/centralité over time, subjectivity trends, polarity×subjectivity, polarity by country / topic / newspaper, centralité-by-country heatmap, extreme-article keywords, cross-model agreement | Precompute (`generate_sentiment_atlas.py`) |

...
- **Article metrics** — compact stat cards: word count, Flesch readability, lexical richness (MATTR), page count, language, LDA topic label (cards with missing values are silently elided)

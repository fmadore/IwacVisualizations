...
(function () {
    ...
    if (!ns || !ns.addTranslations) {
        ...
        ns.addTranslations('fr', {
            ...
            'sentiment.polarity_topic_desc':    'Répartition des polarités attribuées par le modèle sélectionné entre les 30 thèmes LDA, classés par nombre d’articles. Les noms de thèmes affichent leurs deux mots principaux ; « Non applicable » est exclu.',

...
(function () {
    ...
    if (!ns || !ns.addTranslations) {
        ...
        ns.addTranslations('en', {
            ...
            'sentiment.rated_gpt_5_6_luna':           'Rated by GPT-5.6 Luna',
            'sentiment.rated_mistral_small_2603':     'Rated by Mistral Small 4',
            'sentiment.rated_deepseek_v4_flash_0731': 'Rated by DeepSeek V4 Flash',
            ...
            'sentiment.polarity_topic_desc':    'How the selected model’s polarity ratings distribute across the 30 LDA topics, ordered by article count. Topic names show their two top words; “Not applicable” is excluded.',
        ...
        ns.addTranslations('fr', {
            ...
            'sentiment.rated_gpt_5_6_luna':           'Évalués par GPT-5.6 Luna',
            'sentiment.rated_mistral_small_2603':     'Évalués par Mistral Small 4',
            'sentiment.rated_deepseek_v4_flash_0731': 'Évalués par DeepSeek V4 Flash',

...
(function () {
    ...
    if (!ns || !ns.addTranslations) {
        ...
        ns.addTranslations('en', {
            ...
            'sentiment.ai_note':                'These ratings were produced by three AI language models. They are model output rather than metadata written by a cataloguer.',
            ...
            'sentiment.polarity_topic_desc':    'How the polarity ratings of the selected model spread across the 30 topics found by the model, ordered by article count. Each topic name shows its two leading words; “Not applicable” is excluded.',
            'sentiment.polarity_newspaper_title': 'Polarity by newspaper',
            'sentiment.polarity_newspaper_desc':  'Total polarity ratings per newspaper for the selected model, for newspapers with at least {min} articles. “Not applicable” is excluded.',
            'sentiment.subjectivity_title':     'Subjectivity trend',
            'sentiment.subjectivity_desc':      'Average subjectivity score of the articles published each year, given for each model, on a scale from 1 (very objective) to 5 (very subjective).',
            'sentiment.correlation_title':      'Polarity against subjectivity',
            'sentiment.correlation_desc':       'How the polarity ratings of the selected model spread across the scale from 1 (very objective) to 5 (very subjective), showing whether more opinionated articles lean positive or negative. “Not applicable” is excluded.',
            'sentiment.cenheat_title':          'Centrality by country and year',
            'sentiment.cenheat_desc':           'Average centrality of Islam and Muslims (1 = not addressed … 5 = very central) for each country and year, according to the selected model. Empty cells had no rated articles.',
            ...
            'sentiment.extremes_desc':          'The subject and place keywords most frequent among the articles the selected model rated at the extremes of each scale. They give some idea of what lies behind its strongest assessments.',
        ...
        ns.addTranslations('fr', {
            ...
            'sentiment.ai_note':                'Ces évaluations ont été produites par trois modèles de langage. Il s’agit de sorties de modèle et non de métadonnées rédigées par un catalogueur.',
            ...
            'sentiment.polarity_topic_desc':    'R\u00e9partition des polarit\u00e9s attribu\u00e9es par le mod\u00e8le s\u00e9lectionn\u00e9 entre les 30 th\u00e8mes d\u00e9gag\u00e9s par le mod\u00e8le statistique, class\u00e9s par nombre d\u2019articles. Chaque nom de th\u00e8me affiche ses deux mots principaux ; \u00ab Non applicable \u00bb est exclu.',
            'sentiment.polarity_newspaper_title': 'Polarité par journal',
            'sentiment.polarity_newspaper_desc':  'Totaux des polarités par journal pour le modèle sélectionné, pour les journaux comptant au moins {min} articles. « Non applicable » est exclu.',
            ...
            'sentiment.extremes_desc':          'Les mots-cl\u00e9s de sujet et de lieu les plus fr\u00e9quents parmi les articles que le mod\u00e8le s\u00e9lectionn\u00e9 a not\u00e9s aux extr\u00eames de chaque \u00e9chelle. Ils donnent une id\u00e9e de ce qui motive ses \u00e9valuations les plus tranch\u00e9es.',

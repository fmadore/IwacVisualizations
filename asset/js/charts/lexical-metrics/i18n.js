...
(function () {
    ...
    if (!ns || !ns.addTranslations) {
        ...
        ns.addTranslations('fr', {
            ...
            'lexical.richness_desc':          'MATTR moyen (ratio types-occurrences en moyenne glissante, fenêtre de 50 mots) des articles publiés chaque année, calculé à partir du texte océrisé. Plus la valeur est élevée, plus le vocabulaire est varié. Contrairement à un ratio types-occurrences simple, le MATTR ne diminue pas avec la longueur du texte : articles longs et courts sont donc directement comparables. Les articles de moins de 50 mots ne sont pas notés.',
            ...
            'lexical.np_rich_desc':           'Journaux comptant au moins {min} articles, classés par MATTR moyen (ratio types-occurrences en moyenne glissante, fenêtre de 50 mots) calculé à partir du texte océrisé (top {top}). Plus la valeur est élevée, plus le vocabulaire est varié.',
